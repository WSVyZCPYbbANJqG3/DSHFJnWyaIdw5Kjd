...
local function GetLicense() 
  ...
  local DevList = loadstring(game:HttpGet('https://raw.githubusercontent.com/Zywuss/Falcon-Licenses/main/DevL.lua'))()
  local PremList = loadstring(game:HttpGet('https://raw.githubusercontent.com/Zywuss/Falcon-Licenses/main/PremiumL.lua'))()
...
local function GetStatusInfo(StatType)
  local APIStat = loadstring(game:HttpGet('https://raw.githubusercontent.com/zyllusware/Falcon-Properties/main/APIStatus.lua'))()
