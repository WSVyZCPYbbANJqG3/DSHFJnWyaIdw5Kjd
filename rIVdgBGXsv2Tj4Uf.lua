...
local function isExploitSupported()
    if identifyexecutor() == "Krnl" then
        return true
    end
    if identifyexecutor() == "Furk" then
        return false
    end
    if identifyexecutor() == "WRD-API" then
        return false
    end
    if identifyexecutor() == "Sentinel" then
        return true
    end
    
end

function PlayAnimation(AnimText)
...
local Rnum = math.random(10000,100000)
getgenv().Address = '&*@-'..Rnum

if isExploitSupported == false then
    game.Players.LocalPlayer:Kick("Unable to identify the parent of a new script insertion named NUCLEON, Script_NUCLEON's script Address = "..getgenv().Address)
end
...
error("Yess lets goooooooooooooooo Nucleon da best man fuck u nigga xd xd")
